...
const StudioList = () => {
    ...
    const fetchStudios = async () => {
        try {
            ...
            const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/studios`, config);
            setStudios(data);
        } catch (error) {
            console.error(error);
        }
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_BASE_URL}/studios`, studioData, config);
